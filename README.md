...
#### 1. Data Flow Activity (ETL_BookingDimData)
...
1. **Sources**:
    ...
    ![CosmoDBPythonGenerateBookingData](./assets/images/generate_cosmodb_mock_data.png)
...
#### **2. Stored Procedure Activity** (AggregateBookingFactData)
